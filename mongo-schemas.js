...
const studentAssignmentSchema = new Schema({
  _id: { type: Schema.Types.ObjectId, required: [true, 'error'] },
  userId: { type: Schema.Types.ObjectId, required: [true, 'error'] },
  groupId: { type: Schema.Types.ObjectId, required: [true, 'error'] },
});
studentAssignmentSchema.plugin(uniqueValidator, { message: 'already exists' });
...
teacherAssignmentSchema.plugin(uniqueValidator, { message: 'already exists' });

const groupSchema = new Schema({
  _id: { type: Schema.Types.ObjectId, required: [true, 'error'] },
  name: { type: String, required: [true, 'error'] },
  teachers: { type: [Schema.Types.ObjectId], required: [true, 'error'] },
  students: { type: [Schema.Types.ObjectId], required: [true, 'error'] },
});
...
const requestSchema = new Schema({
  _id: { type: Schema.Types.ObjectId, required: [true, 'error'] },
  userId: { type: Schema.Types.ObjectId, required: [true, 'error'] },
  section: { type: String, required: [true, 'error'] },
  status: String,
});
requestSchema.plugin(uniqueValidator, { message: 'already exists' });
...
const assignmentSchema = new Schema({
  ...
  teacherId: { type: Schema.Types.ObjectId, required: [true, 'error'] },
});
assignmentSchema.plugin(uniqueValidator, { message: 'already exists' });

const submissionSchema = new Schema({
  _id: { type: Schema.Types.ObjectId, required: [true, 'error'] },
  questions: { type: [Schema.Types.ObjectId], required: [true, 'error'] },
  answeres: { type: Array, required: [true, 'error'] },
  completeDate: { type: Date, required: [true, 'error'] },
  assignmentId: { type: Schema.Types.ObjectId, required: [true, 'error'] },
  userId: { type: Schema.Types.ObjectId, required: [true, 'error'] },
});
